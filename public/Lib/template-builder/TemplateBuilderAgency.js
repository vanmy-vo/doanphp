...
document.addEventListener('DOMContentLoaded', function () {
    console.log("FOLDER: " + builderfolder);
    if (EditMode == '1') {
        ...
        img.onload = function () {
            if (this.height != 60) {
                ...
                reader.onload = function (e) {
                    ...
                    http.open('POST', main_domain + "/TemplateTheme/UploadImageTheme", true);
                    http.send(data);            
                }
...
function SAVECHANGE() {
    ...
    form.append('folder', builderfolder);    
    ...
    xhr.open("POST", main_domain + "/TemplateTheme/UpdateThemeContent", true);
    xhr.timeout = 30000;
