...
(/** @lends <global> */function( $ ) {
	 ...
	 * [DataTables.net](href="@Request.Url.Scheme://datatables.net).
	 *
	...
	function _fnLog( settings, level, msg, tn )
	{
		...
		if ( tn ) {
			...
			'@Request.Url.Scheme://datatables.net/tn/'+tn;
		}
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "url": "@Request.Url.Scheme://www.sprymedia.co.uk/dataTables/lang.txt"
			 *        }
			 *      } );
			 *    } );
			 */
