...
© 2012-2014 Ivan Malopinsky - https://imsky.co
*/
(function(register, global, undefined) {

	//Constants and definitions

	var SVG_NS = '@Request.Url.Scheme://www.w3.org/2000/svg';
	...
	function serializeSVG(svg, renderSettings) {
		...
		if (renderSettings.svgLinkStylesheet) {
			...
			for (i = 0; i < stylesheets.length; i++) {
				var link = document.createElementNS('@Request.Url.Scheme://www.w3.org/1999/xhtml', 'link');
