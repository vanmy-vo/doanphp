...
![](https://imsky.github.io/holder/images/header.png)

Holder renders image placeholders on the client side using SVG.

Used by [Bootstrap](https://getbootstrap.com), thousands of [open source projects](https://github.com/search?q=holder.js+in%3Apath&type=Code&ref=searchresults), and [many other sites](https://search.nerdydata.com/search/#!/searchTerm=holder.js/searchPage=1/sort=pop).
...
* [jsDelivr](https://www.jsdelivr.com): <https://www.jsdelivr.com/#!holder>
* [Rails Assets](https://rails-assets.org): `gem 'rails-assets-holderjs'`
* [Meteor](https://atmospherejs.com/): `mrt add holder`
...
![](https://imsky.github.io/holder/images/holder_sky.png)![](https://imsky.github.io/holder/images/holder_vine.png)![](https://imsky.github.io/holder/images/holder_lava.png)
...
```html
<head>
<link href="@Request.Url.Scheme://.../font-awesome.css" rel="stylesheet" class="holderjs">
</head>
<body>
...
Holder is provided under the [MIT License](https://opensource.org/licenses/MIT).

Credits
-------

Holder is a project by [Ivan Malopinsky](https://imsky.co).
