                                        ...
                                        <div class="post--item post--layout-2">
                                            <div class="post--img">
                                                <a href="" class="thumb"><img
                                                        src="{{asset('user/img/post-img/f7f9000cf953290d7042-168794481470437.jpg')}}"
                                                        alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h4 class="h4"><a href="" class="btn-link">Chiều 28.6, TP.HCM có
                                                                mưa lớn ở khắp nơi, nhiều tuyến đường bị ngập cục bộ. Dự
                                                                báo trong đêm nay vẫn còn mưa rào và giông vài nơi.</a>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <ul class="nav row">
                                            ...
                                            <li class="col-xs-6">
                                                ...
                                                <div class="post--item post--layout-2">
                                                    <div class="post--img">
                                                        <a href="" class="thumb"><img
                                                                src="{{asset('user/img/post-img/xe-may-dien.png')}}"
                                                                alt=""></a>
                                                        ...
                                                        <div class="post--info">
                                                            ...
                                                            <div class="title">
                                                                <h3 class="h4"><a href="" class="btn-link">Xe máy điện
                                                                        Honda U-Go có bản nâng cấp giá 26 triệu
                                                                        đồng...</a></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="col-md-12">
                                        ...
                                        <div class="post--item post--layout-1 post--title-large">
                                            <div class="post--img a">
                                                ...
                                                <a href="" class="thumb"><img
                                                        src="{{asset('user/img/post-img/black-pinkk.png')}}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title text-xxs-ellipsis">
                                                        <h2 class="h4"><a href="" class="btn-link">Vé xem BlackPink tại
                                                                Việt Nam đã được rao bán, cao nhất 25 triệu đồng</a>
                                                        </h2>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <li class="col-md-4 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img b">
                                                ...
                                                <a href="" class="thumb"><img
                                                        src="{{asset('user/img/post-img/2523523523.jpg')}}"
                                                        style="object-fit: fill" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h2 class="h4"><a href="" class="btn-link">‘Indiana Jones 5’:
                                                                Tạm biệt Indy, tạm biệt một di sản</a></h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="main--sidebar col-md-4 col-sm-5 ptop--30 pbottom--30" data-sticky-content="true">
                <div class="sticky-content-inner">
                    ...
                    <div class="slider ad--widget" id="img">
                        <a href="#" target="_blank"><img src="<?= $databases[0]->image ?>"> </a>
                    </div>
                    <script>
                                ...
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="" class="thumb"><img
                                                        src="{{asset('user/img/post-img/463634634.jpg')}}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="" class="btn-link">Mỗi cầu thủ nhận 700
                                                                triệu khi dự World Cup 2023, cao nhất 6,3 tỉ đồng</a>
                                                        </h3>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ul class="nav row gutter--15" data-ajax-content="inner">
                                    <li class="col-xs-12">
                                        ...
                                        <div class="post--item post--layout-1">
                                            <div class="post--img">
                                                <a href="" class="thumb"><img
                                                        src="{{asset('user/img/post-img/235235235.jpg')}}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="" class="btn-link">Giá iPhone có thể đã
                                                                'xuống đáy'</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ul class="nav" data-ajax-content="inner">
                                    <li>
                                        ...
                                        <div class="post--item post--layout-3">
                                            <div class="post--img">
                                                <a href="" class="thumb"><img
                                                        src="{{asset('user/img/post-img/252532523.jpg')}}" alt=""></a>
                                                ...
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="" class="btn-link">Trí tuệ nhân tạo nguy
                                                                hiểm như thế nào?</a></h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
