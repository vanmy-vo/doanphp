    ...
    <div class="main--breadcrumb">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active"><span>Quân sự</span></li>
            </ul>
        </div>
    </div>
    <!-- Main Breadcrumb End -->
                ...
                <div class="main--content col-md-8 col-sm-7" data-sticky-content="true">
                    <div class="sticky-content-inner">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8 col-sm-12 col-xs-8 col-xxs-12">
                                                <div class="post--info">
                                                    ...
                                                    <div class="title">
                                                        <h3 class="h4"><a href="" class="btn-link">Phương Tây đã huấn luyện hơn 17.000 tân binh Ukraine</a></h3>
                                                    </div>
                                                </div>
                        ...
                        <div class="pagination--wrapper clearfix bdtop--1 bd--color-2 ptop--60 pbottom--30">
                            <p class="pagination-hint float--left">Trang 02 của 03</p>
