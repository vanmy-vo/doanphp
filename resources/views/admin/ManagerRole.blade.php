    ...
    <div class="modal-dialog modal-md" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" id="updateRoleForm" method="">
        ...
        <div class="x_panel" style="padding:15px!important">
            <div class="x_title" style="border-bottom:none;padding-bottom:0px;margin-bottom:0px">
                ...
                <div class="nav navbar-right green">
                    <a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addRole"><i class="fa fa-plus-square" aria-hidden="true"></i> Thêm</a>
                </div>
                <div class="clearfix"></div>
            </div>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="tc1">                        
                            <a class="btn btn-xs btn-success" data-toggle="modal" data-target="#updateRole"><i class="fa fa-pencil-square-o"></i></a>
