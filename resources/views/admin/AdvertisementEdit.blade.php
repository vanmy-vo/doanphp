                    ...
                    <div class="filterpane">
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p name="ads_name" class="col-md-6"></p>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <img name="ads_img" src="" alt="" width="200" height="200" style="margin-top: 15px; object-fit:fill">
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p class="col-md-6" name="ads_content"></p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <p name="ads_link" class="col-md-6" style="word-wrap: break-word;"></p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                ...
                <form action="" id="addAdsForm" method="GET" action="{{route('addAds')}}">
                    <div id="FilterContentCenter">
                        ...
                        <div class="filerfooter" style="margin-top:20px">
                            ...
                            <button onclick="ShowHide(false)" class="btn btn-dark">Hủy</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 10px">
        <div class="device-search-box">
            ...
            <form method="GET" action="{{route('searchads')}}" class="form-inline">
                @csrf
                <input name="searchads" class="form-control mr-sm-2" type="search" placeholder="Nhập từ khóa tìm kiếm"
                    aria-label="Search">
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel" style="padding:15px;overflow:auto">
            ...
            {{-- table --}}
            <form enctype="multipart/form-data" action="{{route('updateAds',['id'=>$ads->id])}}" id="updateAdsForm" method="POST">
                @csrf
                <div id="FilterContentCenter">
                    <div class="filterpane" style="margin-bottom:0px;padding-bottom:0px">
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input name="title_ads" type="text" class="form-control input-edit" value="{{$ads->title_ads}}"/>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input name="imageupload" type="file" class="form-control input-edit" value="" />
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group">
                                <img  style="display: block;margin-left: auto;margin-right: auto;width: 70%;" src="{{ asset('uploads/ads/' . $ads->img) }}" alt="" onerror="this.style.display='none'">
                              </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3 col-sm-3 col-xs-12">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <input name="content_ads" type="text" class="form-control input-edit" value="{{$ads->content_ads}}" />
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                <textarea name="link" type="text" class="form-control input-edit">{{$ads->link}}</textarea>
                            </div>
                            <div class="clearfix"></div>    
                        </div>
                    </div>
