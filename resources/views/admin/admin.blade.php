...
<head>
    ...
    <link href="<?=SITE_PATH?>/Lib/vendors/bootstrap-progressbar/css/bootstrap-progressbar-3.3.4.min.css" rel="stylesheet">
    <link href="<?=SITE_PATH?>/Lib/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet" />
    <link href="<?=SITE_PATH?>/Lib/vendors/bootstrap-daterangepicker/daterangepicker.css" rel="stylesheet">
    <link href="<?=SITE_PATH?>/Lib/vendors/custom.css" rel="stylesheet">
...
<body class="nav-md">
    ...
    <script src="<?=SITE_PATH?>/Lib/vendors/fastclick/lib/fastclick.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/nprogress/nprogress.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/Chart.js/dist/Chart.min.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/gauge.js/dist/gauge.min.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/iCheck/icheck.min.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/skycons/skycons.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/Flot/jquery.flot.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/Flot/jquery.flot.pie.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/Flot/jquery.flot.time.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/Flot/jquery.flot.stack.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/Flot/jquery.flot.resize.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/flot.curvedlines/curvedLines.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/DateJS/build/date.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/moment/min/moment.min.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/bootstrap-daterangepicker/daterangepicker.js"></script>
    <script src="<?=SITE_PATH?>/Lib/vendors/custom.js"></script>
